...
class ObjekSprite:
    ...
    def get_sprite_projection(self):
        ...
        pos = self.screen_x - self.sprite_half_width, SETENGAH_HEIGHT - proj_height // 2 + height_shift
    ...
    def get_sprite(self):
        ...
        self.screen_x = (SETENGAH_NUM_RAYS + delta_rays) * SKALA
